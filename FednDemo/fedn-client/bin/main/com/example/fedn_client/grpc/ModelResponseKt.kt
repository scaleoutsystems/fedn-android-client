...
public object ModelResponseKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.example.fedn_client.grpc.ModelResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.example.fedn_client.grpc.ModelResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.example.fedn_client.grpc.ModelResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.example.fedn_client.grpc.ModelResponse.copy(block: com.example.fedn_client.grpc.ModelResponseKt.Dsl.() -> kotlin.Unit): com.example.fedn_client.grpc.ModelResponse =
  com.example.fedn_client.grpc.ModelResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()
