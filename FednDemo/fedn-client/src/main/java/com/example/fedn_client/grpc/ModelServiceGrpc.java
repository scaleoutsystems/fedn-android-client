...
public final class ModelServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.fedn_client.grpc.ModelRequest,
      com.example.fedn_client.grpc.ModelResponse> getUploadMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Upload",
      requestType = com.example.fedn_client.grpc.ModelRequest.class,
      responseType = com.example.fedn_client.grpc.ModelResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.example.fedn_client.grpc.ModelRequest,
      com.example.fedn_client.grpc.ModelResponse> getUploadMethod() {
    io.grpc.MethodDescriptor<com.example.fedn_client.grpc.ModelRequest, com.example.fedn_client.grpc.ModelResponse> getUploadMethod;
      ...
      synchronized (ModelServiceGrpc.class) {
        if ((getUploadMethod = ModelServiceGrpc.getUploadMethod) == null) {
          ModelServiceGrpc.getUploadMethod = getUploadMethod =
              io.grpc.MethodDescriptor.<com.example.fedn_client.grpc.ModelRequest, com.example.fedn_client.grpc.ModelResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Upload"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.fedn_client.grpc.ModelRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.fedn_client.grpc.ModelResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.fedn_client.grpc.ModelRequest,
      com.example.fedn_client.grpc.ModelResponse> getDownloadMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.fedn_client.grpc.ModelRequest,
      com.example.fedn_client.grpc.ModelResponse> getDownloadMethod() {
    io.grpc.MethodDescriptor<com.example.fedn_client.grpc.ModelRequest, com.example.fedn_client.grpc.ModelResponse> getDownloadMethod;
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<com.example.fedn_client.grpc.ModelRequest> upload(
        io.grpc.stub.StreamObserver<com.example.fedn_client.grpc.ModelResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getUploadMethod(), responseObserver);
    }

    /**
     */
    default void download(com.example.fedn_client.grpc.ModelRequest request,
        io.grpc.stub.StreamObserver<com.example.fedn_client.grpc.ModelResponse> responseObserver) {
  ...
  public static final class ModelServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<com.example.fedn_client.grpc.ModelRequest> upload(
        io.grpc.stub.StreamObserver<com.example.fedn_client.grpc.ModelResponse> responseObserver) {
    ...
    /**
     */
    public void download(com.example.fedn_client.grpc.ModelRequest request,
        io.grpc.stub.StreamObserver<com.example.fedn_client.grpc.ModelResponse> responseObserver) {
  ...
  public static final class ModelServiceBlockingStub
    ...
    /**
     */
    public java.util.Iterator<com.example.fedn_client.grpc.ModelResponse> download(
        com.example.fedn_client.grpc.ModelRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_DOWNLOAD:
          serviceImpl.download((com.example.fedn_client.grpc.ModelRequest) request,
              (io.grpc.stub.StreamObserver<com.example.fedn_client.grpc.ModelResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              com.example.fedn_client.grpc.ModelRequest,
              com.example.fedn_client.grpc.ModelResponse>(
