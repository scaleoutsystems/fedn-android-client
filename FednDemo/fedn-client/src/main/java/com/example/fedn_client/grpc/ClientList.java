...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.example.fedn_client.grpc.ClientList)) {
      return super.equals(obj);
    }
    com.example.fedn_client.grpc.ClientList other = (com.example.fedn_client.grpc.ClientList) obj;
  ...
  public static com.example.fedn_client.grpc.ClientList parseFrom(
  ...
  public static com.example.fedn_client.grpc.ClientList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.example.fedn_client.grpc.ClientList parseFrom(
  ...
  public static com.example.fedn_client.grpc.ClientList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.example.fedn_client.grpc.ClientList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.example.fedn_client.grpc.ClientList parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.example.fedn_client.grpc.ClientList prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.example.fedn_client.grpc.ClientList.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.example.fedn_client.grpc.ClientList getDefaultInstanceForType() {
      return com.example.fedn_client.grpc.ClientList.getDefaultInstance();
    }

    @java.lang.Override
    public com.example.fedn_client.grpc.ClientList build() {
      com.example.fedn_client.grpc.ClientList result = buildPartial();
    ...
    @java.lang.Override
    public com.example.fedn_client.grpc.ClientList buildPartial() {
      com.example.fedn_client.grpc.ClientList result = new com.example.fedn_client.grpc.ClientList(this);
    ...
    private void buildPartialRepeatedFields(com.example.fedn_client.grpc.ClientList result) {
      if (clientBuilder_ == null) {
    ...
    private void buildPartial0(com.example.fedn_client.grpc.ClientList result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.example.fedn_client.grpc.ClientList) {
        return mergeFrom((com.example.fedn_client.grpc.ClientList)other);
      } else {
    ...
    public Builder mergeFrom(com.example.fedn_client.grpc.ClientList other) {
      if (other == com.example.fedn_client.grpc.ClientList.getDefaultInstance()) return this;
      if (clientBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.example.fedn_client.grpc.Client m =
                  input.readMessage(
                      com.example.fedn_client.grpc.Client.parser(),
                      extensionRegistry);
              if (clientBuilder_ == null) {
                ensureClientIsMutable();
                client_.add(m);
    ...
    private void ensureClientIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        client_ = new java.util.ArrayList<com.example.fedn_client.grpc.Client>(client_);
  ...
  public static com.example.fedn_client.grpc.ClientList getDefaultInstance() {
