...
public inline fun modelUpdate(block: com.example.fednclient.grpc.ModelUpdateKt.Dsl.() -> kotlin.Unit): com.example.fednclient.grpc.ModelUpdate =
  com.example.fednclient.grpc.ModelUpdateKt.Dsl._create(com.example.fednclient.grpc.ModelUpdate.newBuilder()).apply { block() }._build()
/**
...
public object ModelUpdateKt {
  ...
  public class Dsl private constructor(
    private val _builder: com.example.fednclient.grpc.ModelUpdate.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.example.fednclient.grpc.ModelUpdate.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.example.fednclient.grpc.ModelUpdate = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.example.fednclient.grpc.ModelUpdate.copy(block: com.example.fednclient.grpc.ModelUpdateKt.Dsl.() -> kotlin.Unit): com.example.fednclient.grpc.ModelUpdate =
  com.example.fednclient.grpc.ModelUpdateKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.example.fednclient.grpc.ModelUpdateOrBuilder.senderOrNull: com.example.fednclient.grpc.Client?
  get() = if (hasSender()) getSender() else null

public val com.example.fednclient.grpc.ModelUpdateOrBuilder.receiverOrNull: com.example.fednclient.grpc.Client?
