...
public final class ReducerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.fednclient.grpc.GetGlobalModelRequest,
      com.example.fednclient.grpc.GetGlobalModelResponse> getGetGlobalModelMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetGlobalModel",
      requestType = com.example.fednclient.grpc.GetGlobalModelRequest.class,
      responseType = com.example.fednclient.grpc.GetGlobalModelResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.fednclient.grpc.GetGlobalModelRequest,
      com.example.fednclient.grpc.GetGlobalModelResponse> getGetGlobalModelMethod() {
    io.grpc.MethodDescriptor<com.example.fednclient.grpc.GetGlobalModelRequest, com.example.fednclient.grpc.GetGlobalModelResponse> getGetGlobalModelMethod;
      ...
      synchronized (ReducerGrpc.class) {
        if ((getGetGlobalModelMethod = ReducerGrpc.getGetGlobalModelMethod) == null) {
          ReducerGrpc.getGetGlobalModelMethod = getGetGlobalModelMethod =
              io.grpc.MethodDescriptor.<com.example.fednclient.grpc.GetGlobalModelRequest, com.example.fednclient.grpc.GetGlobalModelResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetGlobalModel"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.fednclient.grpc.GetGlobalModelRequest.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getGlobalModel(com.example.fednclient.grpc.GetGlobalModelRequest request,
        io.grpc.stub.StreamObserver<com.example.fednclient.grpc.GetGlobalModelResponse> responseObserver) {
  ...
  public static final class ReducerStub
    ...
    /**
     */
    public void getGlobalModel(com.example.fednclient.grpc.GetGlobalModelRequest request,
        io.grpc.stub.StreamObserver<com.example.fednclient.grpc.GetGlobalModelResponse> responseObserver) {
  ...
  public static final class ReducerBlockingStub
    ...
    /**
     */
    public com.example.fednclient.grpc.GetGlobalModelResponse getGlobalModel(com.example.fednclient.grpc.GetGlobalModelRequest request) {
  ...
  public static final class ReducerFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.fednclient.grpc.GetGlobalModelResponse> getGlobalModel(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_GLOBAL_MODEL:
          serviceImpl.getGlobalModel((com.example.fednclient.grpc.GetGlobalModelRequest) request,
              (io.grpc.stub.StreamObserver<com.example.fednclient.grpc.GetGlobalModelResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.example.fednclient.grpc.GetGlobalModelRequest,
              com.example.fednclient.grpc.GetGlobalModelResponse>(
