...
import com.example.fednclient.grpc.ModelServiceGrpc.getServiceDescriptor
...
public object ConnectorGrpcKt {
  ...
  public val allianceStatusStreamMethod: MethodDescriptor<ClientAvailableMessage, com.example.fednclient.grpc.Status>
    @JvmStatic
    get() = ConnectorGrpc.getAllianceStatusStreamMethod()

  public val sendStatusMethod: MethodDescriptor<com.example.fednclient.grpc.Status, Response>
    @JvmStatic
  ...
  public class ConnectorCoroutineStub @JvmOverloads constructor(
    ...
    public fun allianceStatusStream(request: ClientAvailableMessage, headers: Metadata =
        Metadata()): Flow<com.example.fednclient.grpc.Status> = serverStreamingRpc(
      channel,
     ...
     * @return The single response from the server.
     */
    public suspend fun sendStatus(request: com.example.fednclient.grpc.Status, headers: Metadata = Metadata()):
        Response = unaryRpc(
      channel,
  ...
  public abstract class ConnectorCoroutineImplBase(
     ...
     * @param request The request from the client.
     */
    public open fun allianceStatusStream(request: ClientAvailableMessage): Flow<com.example.fednclient.grpc.Status> =
        throw
     ...
     * @param request The request from the client.
     */
    public open suspend fun sendStatus(request: com.example.fednclient.grpc.Status): Response = throw
